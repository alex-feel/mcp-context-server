...
- **SUMMARY_TIMEOUT_S**: Timeout in seconds for summary generation API calls - defaults to 240.0
- **SUMMARY_RETRY_MAX_ATTEMPTS**: Maximum retry attempts on transient errors - defaults to 5
