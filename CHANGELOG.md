...
## [3.0.0](https://github.com/alex-feel/mcp-context-server/compare/v2.2.2...v3.0.0) (2026-09-09)
...
* add access-control schema with server-stamped ownership and visibility ([1c0a3d9](https://github.com/alex-feel/mcp-context-server/commit/1c0a3d9e228261459cfc2ef93fff1d8dcef90d0c))
* add access-control schema with server-stamped ownership and visibility ([30f4ef3](https://github.com/alex-feel/mcp-context-server/commit/30f4ef323900cf89c3e87119dc67542461457857))
...
* add JWT authentication provider with IdP-agnostic claims mapping ([9332776](https://github.com/alex-feel/mcp-context-server/commit/9332776145aa988436bacb7f9ac402f31bf5ca92))
* add JWT authentication provider with IdP-agnostic claims mapping ([01c29c0](https://github.com/alex-feel/mcp-context-server/commit/01c29c0c7431eaa4d3a1c3c6dc3f67d237aeee7b))
...
* add query-side instruction support for instruct-aware embedding models ([8408cd3](https://github.com/alex-feel/mcp-context-server/commit/8408cd3ff2bcfb497a88d03d764a1aeb31534fff))
...
* bound tool-boundary inputs and correct response contracts ([7058183](https://github.com/alex-feel/mcp-context-server/commit/7058183b5aa55680b082966401ef69daa435f6d9))
...
* classify FTS engine failures by catalog provenance and keep boot diagnostics fault-tolerant ([38db489](https://github.com/alex-feel/mcp-context-server/commit/38db4898a887d3305222ca7b77f43d1d4a899925))
...
* correct nested metadata key handling and bound float filter SQL ([0c194cb](https://github.com/alex-feel/mcp-context-server/commit/0c194cbd44db7e9da5a195a0b7d4a3bbe90d3508))
...
* harden backend connection lifecycle and fault accounting ([84a2a31](https://github.com/alex-feel/mcp-context-server/commit/84a2a3140b64277a4d9bf599e092eadbf24952de))
* harden backend connection lifecycle and fault classification ([ba9da54](https://github.com/alex-feel/mcp-context-server/commit/ba9da547c99012b38f126d42ddf3b2c143e862e4))
...
* make ranked search deterministic and correct FTS handling ([87713a8](https://github.com/alex-feel/mcp-context-server/commit/87713a878573144211627fc19829084d28a19c06))
* make tags a set per entry and align repository ordering across backends ([adf726d](https://github.com/alex-feel/mcp-context-server/commit/adf726d70b939fae0067d12e821336113fe9f80f))
...
* protect migration CLI against data loss and unstorable input ([4d1a845](https://github.com/alex-feel/mcp-context-server/commit/4d1a845c8c792f1bb245ff7bbb727e0d745839a5))
* protect the migration CLI against timeouts, oversized values, and schema drift ([639f324](https://github.com/alex-feel/mcp-context-server/commit/639f32494c98195341cd53d32242e2a62d7b220e))
...
* serve every ranked-search page from one fixed-depth ordering ([e38d434](https://github.com/alex-feel/mcp-context-server/commit/e38d4347406f127d280f5ba46d09e7bf47e573b0))
...
* validate typed metadata and image payloads before generation runs ([3afeeb3](https://github.com/alex-feel/mcp-context-server/commit/3afeeb3858f4cd0aafda15838ee9a72548a901fa))
