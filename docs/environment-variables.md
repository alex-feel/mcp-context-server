...
|---------------------|---------|-----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `LOG_LEVEL`         | string  | `ERROR`                     | Application log level. Options: `DEBUG`, `INFO`, `WARNING`, `ERROR`, `CRITICAL`. The single effective verbosity control: at startup the server also aligns FastMCP's own non-propagating logger tree with this level |
